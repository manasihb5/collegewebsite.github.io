                                ...
                                <div class="white_card_header">
                                    <div class="box_header m-0">
                                        <div class="main-title">
                                            <h3 class="m-0">Students Who Paid Fees</h3>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="QA_table table-responsive ">
                                        ...
                                        <table class="table pt-0">
                                            ...
                                            ?>
                                                <tr>
                                                    <?php
                                                    $data = "SELECT * FROM users where id = '{$rows['uid']}'";
                                                    ...
                                                    <td class="nowrap"><?php echo $rows['txn_id']; ?></td>
                                                    <td class="nowrap"><?php echo $rows['syear']; ?></td>
                                                    <td class="nowrap"><?php echo $rows['course']; ?></td>
                                                    <td class="nowrap"><a
                                                            href="invoice.php?id=<?php echo $rows['txn_id']; ?>"><button
